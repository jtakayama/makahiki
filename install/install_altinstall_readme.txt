...
-------------------------------------------------------------------------------
[Everything after this line is WIP]

The install/ folder contains the install_altinstall.py script and its 
dependencies.

Usage of install_altinstall.py:
-------------------------------------------------------------------------------
./install_altinstall.py [--dependencies | --pip | initialize_instance | update_instance] --os [redhat] --arch [x64]
