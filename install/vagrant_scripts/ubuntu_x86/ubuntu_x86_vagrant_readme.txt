...
[COMING SOON]
2.0.3. Download the Makahiki Source Code
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
"precise32" defines the computer name of the virtual machine. (The virtual 
machine itself will be visible in VirtualBox by the name of its containing 
folder. The example virtual machine will be named "ubuntu_x86_makahiki_" 
followed by 10 digits.)

:path => "bootstrap_runner.sh" defines the location of a shell script
that will be run when the machine is started for the first time, or whenever 
the "vagrant reload" command is used. The bootstrap_runner.sh file will be 
moved to the Vagrant virtual machine's folder in the next step.
===============================================================================
...
2.1.0. Set up Makahiki in the Virtual Machine
===============================================================================
Section 2.1's subsections describe the process of configuring Makahiki in 
the virtual machine. 
===============================================================================

2.1.3. Start the Virtual Machine and Run the Provisioning Script
===============================================================================
Use the "vagrant up" command to start the virtual machine:

> vagrant up

Since this is the first time the virtual machine has been started, Vagrant 
will run the "bootstrap_runner.sh" script specified in the Vagrantfile. This
script runs the bootstrap.sh script, which installs the following packages 
...
- Python Imaging Library
  ...
  - python-imaging
  - libjpeg-dev
  - It also creates symbolic links to libz.so and libjpeg.so in /usr/lib:
...
2.1.5. Download the Makahiki Source Code
===============================================================================
...
2.1.6. Configure .bashrc Environment Variables
===============================================================================
...
After closing the document, source the .bashrc file for the changes to 
take effect:
...
- Input lag
- INSERT mode not allowing text to be deleted 
  (the x key needed to be used instead)
- Inconsistent switching in and out of insert mode
-------------------------------------------------------------------------------
===============================================================================

2.1.7. Set Up the "makahiki" Virtual Environment
===============================================================================
...
2.1.8. PostgreSQL Configuration
===============================================================================
...
2.1.9. Install Dependencies With Pip
==============================================================================
You should still be in the makahiki virtual environment.

If you are not currently in the top-level makahiki directory (/home/makahiki 
in this guide), switch to it:
...
2.1.10. Environment Variables Configuration
==============================================================================
...
2.1.13. Configure Networking for the Virtual Machine
===============================================================================

===============================================================================

2.1.14. Increase the RAM of the Virtual Machine
===============================================================================
...
2.1.15. Update the Makahiki Instance
===============================================================================
