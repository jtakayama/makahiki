...
echo "mkdir /vagrant/install-setuptools"
mkdir /vagrant/install-setuptools
echo "wget https://bitbucket.org/pypa/setuptools/raw/0.8/ez_setup.py -P /vagrant/install-setuptools"
wget https://bitbucket.org/pypa/setuptools/raw/0.8/ez_setup.py -P /vagrant/install-setuptools
echo "python /vagrant/install-setuptools/ez_setup.py"
python /vagrant/install-setuptools/ez_setup.py
echo "Cleaning up..."
echo "rm -rf /vagrant/install-setuptools"
