ubuntu_x64_script_readme.txt
============================

This is the README file for the two Makahiki local installation scripts 
in the makahiki/environmentsetup/ubuntu_x64 directory.
...
1.1.0. Prerequisites
--------------------
These shell scripts are intended for use on the Ubuntu Linux 64-bit (x64) 
operating system. Debian-based 64-bit distributions which use apt as their 
...
robot@computer:~/makahiki$ sh environmentsetup/ubuntu_x64/environment_setup.sh
...
(makahiki)robot@computer:~/makahiki$ sh environmentsetup/ubuntu_x64/pip_install.sh
