...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'smartgrid_mgr_gccsettings', (
        ...
        db.send_create_signal(u'smartgrid_mgr', ['GccSettings'])


    def backwards(self, orm):
        # Deleting model 'GccSettings'
        db.delete_table(u'smartgrid_mgr_gccsettings')
