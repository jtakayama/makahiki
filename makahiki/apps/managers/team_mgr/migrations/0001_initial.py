...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Group'
        db.create_table(u'team_mgr_group', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'team_mgr', ['Group'])

        # Adding model 'Team'
        db.create_table(u'team_mgr_team', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'team_mgr', ['Team'])

        # Adding model 'Post'
        db.create_table(u'team_mgr_post', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'team_mgr', ['Post'])


    def backwards(self, orm):
        # Deleting model 'Group'
        db.delete_table(u'team_mgr_group')

        # Deleting model 'Team'
        db.delete_table(u'team_mgr_team')

        # Deleting model 'Post'
        db.delete_table(u'team_mgr_post')
