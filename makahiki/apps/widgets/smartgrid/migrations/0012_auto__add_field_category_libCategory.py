...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('smartgrid_category', 'libCategory', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['smartgrid.LibraryCategory']), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 10, 43, 35, 744179)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 10, 43, 35, 744091)'}),
        ...
        'smartgrid.confirmationcode': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 10, 43, 28, 216793)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
