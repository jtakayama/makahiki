...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LibraryAction.social_bonus'
        db.add_column('smartgrid_libraryaction', 'social_bonus', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'LibraryAction.point_value'
        db.add_column('smartgrid_libraryaction', 'point_value', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LibraryAction.social_bonus'
        db.delete_column('smartgrid_libraryaction', 'social_bonus')

        # Deleting field 'LibraryAction.point_value'
        db.delete_column('smartgrid_libraryaction', 'point_value')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 11, 22, 4, 515776)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 11, 22, 4, 515712)'}),
        ...
        'smartgrid.action': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 3, 5)'}),
        ...
        'smartgrid.confirmationcode': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 11, 22, 4, 291373)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
