...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('smartgrid_librarycategory')

        # Deleting model 'LibraryAction'
        db.delete_table('smartgrid_libraryaction')

        # Deleting model 'LibraryCommitment'
        db.delete_table('smartgrid_librarycommitment')

        # Changing field 'Category.libCategory'
        db.alter_column('smartgrid_category', 'libCategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartgrid_library.LibraryCategory']))
    ...
    def backwards(self, orm):
        ...
        db.create_table('smartgrid_librarycategory', (
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('smartgrid', ['LibraryCategory'])

        # Adding model 'LibraryAction'
        db.create_table('smartgrid_libraryaction', (
        ...
        db.send_create_signal('smartgrid', ['LibraryAction'])
        ...
        # Changing field 'Category.libCategory'
        db.alter_column('smartgrid_category', 'libCategory_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartgrid.LibraryCategory']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 10, 58, 44, 806910)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 10, 58, 44, 806838)'}),
        ...
        'smartgrid.confirmationcode': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 10, 58, 44, 592185)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
