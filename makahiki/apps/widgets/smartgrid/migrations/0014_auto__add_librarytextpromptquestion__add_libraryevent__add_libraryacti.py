...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('smartgrid_librarytextpromptquestion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('libraryaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smartgrid.LibraryAction'])),
            ('question', self.gf('django.db.models.fields.TextField')()),
            ('answer', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('smartgrid', ['LibraryTextPromptQuestion'])

        # Adding model 'LibraryEvent'
        db.create_table('smartgrid_libraryevent', (
            ('libraryaction_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['smartgrid.LibraryAction'], unique=True, primary_key=True)),
            ('duration', self.gf('django.db.models.fields.IntegerField')()),
            ('is_excursion', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('smartgrid', ['LibraryEvent'])

        # Adding model 'LibraryActivity'
        db.create_table('smartgrid_libraryactivity', (
            ('libraryaction_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['smartgrid.LibraryAction'], unique=True, primary_key=True)),
            ('duration', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('smartgrid', ['LibraryActivity'])

        # Adding model 'LibraryCommitment'
        db.create_table('smartgrid_librarycommitment', (
            ('libraryaction_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['smartgrid.LibraryAction'], unique=True, primary_key=True)),
            ('duration', self.gf('django.db.models.fields.IntegerField')(default=5)),
        ))
        db.send_create_signal('smartgrid', ['LibraryCommitment'])

        # Adding field 'LibraryAction.subtype'
        db.add_column('smartgrid_libraryaction', 'subtype', self.gf('django.db.models.fields.CharField')(default=True, max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'LibraryTextPromptQuestion'
        db.delete_table('smartgrid_librarytextpromptquestion')

        # Deleting model 'LibraryEvent'
        db.delete_table('smartgrid_libraryevent')

        # Deleting model 'LibraryActivity'
        db.delete_table('smartgrid_libraryactivity')

        # Deleting model 'LibraryCommitment'
        db.delete_table('smartgrid_librarycommitment')

        # Deleting field 'LibraryAction.subtype'
        db.delete_column('smartgrid_libraryaction', 'subtype')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 9, 29, 12, 824045)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 9, 29, 12, 823977)'}),
        ...
        'smartgrid.action': {
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 3, 6)'}),
        ...
        'smartgrid.category': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'libCategory': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smartgrid.LibraryCategory']"}),
        ...
        'smartgrid.confirmationcode': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 6, 9, 29, 1, 730959)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'smartgrid.libraryactivity': {
            'Meta': {'object_name': 'LibraryActivity', '_ormbases': ['smartgrid.LibraryAction']},
            'admin_note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'confirm_prompt': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'confirm_type': ('django.db.models.fields.CharField', [], {'default': "'text'", 'max_length': '20'}),
            'duration': ('django.db.models.fields.IntegerField', [], {}),
            'libraryaction_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['smartgrid.LibraryAction']", 'unique': 'True', 'primary_key': 'True'}),
            'point_range_end': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'point_range_start': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'smartgrid.librarycategory': {
            'Meta': {'ordering': "('name',)", 'object_name': 'LibraryCategory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'db_index': 'True'})
        },
        'smartgrid.librarycommitment': {
            'Meta': {'object_name': 'LibraryCommitment', '_ormbases': ['smartgrid.LibraryAction']},
            'duration': ('django.db.models.fields.IntegerField', [], {'default': '5'}),
            'libraryaction_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['smartgrid.LibraryAction']", 'unique': 'True', 'primary_key': 'True'})
        },
        'smartgrid.libraryevent': {
            'Meta': {'object_name': 'LibraryEvent', '_ormbases': ['smartgrid.LibraryAction']},
            'duration': ('django.db.models.fields.IntegerField', [], {}),
            'is_excursion': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'libraryaction_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['smartgrid.LibraryAction']", 'unique': 'True', 'primary_key': 'True'})
        },
        'smartgrid.librarytextpromptquestion': {
            'Meta': {'object_name': 'LibraryTextPromptQuestion'},
            'answer': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'libraryaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['smartgrid.LibraryAction']"}),
