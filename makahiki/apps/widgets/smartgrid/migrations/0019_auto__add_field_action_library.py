...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.library'
        db.add_column('smartgrid_action', 'library', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['smartgrid_library.LibraryAction']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Action.library'
        db.delete_column('smartgrid_action', 'library_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 8, 9, 7, 30, 586343)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 8, 9, 7, 30, 586261)'}),
        ...
        'smartgrid.confirmationcode': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 8, 9, 7, 26, 62444)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
