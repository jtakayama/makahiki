...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'notifications_noticetemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notice_type', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('template', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'notifications', ['NoticeTemplate'])
        ...
        db.create_table(u'notifications_usernotification', (
            ...
            ('display_alert', self.gf('django.db.models.fields.BooleanField')(default=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'notifications_noticetemplate')
    ...
    models = {
        ...
        u'notifications.noticetemplate': {
            'Meta': {'object_name': 'NoticeTemplate'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notice_type': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
