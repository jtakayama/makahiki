...
class TestActivityTextForm(forms.Form):
    """Text form."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(TestActivityTextForm, self).__init__(*args, **kwargs)
...
class TestActivityCodeForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(TestActivityCodeForm, self).__init__(*args, **kwargs)
...
class TestActivityFreeResponseForm(forms.Form):
    """Free response form."""
...
class TestActivityImageForm(forms.Form):
    """Image upload form."""
...
class TestActivityFreeResponseImageForm(forms.Form):
